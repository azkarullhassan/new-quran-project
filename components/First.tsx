  ...
  return (
    <section className='w-full'>
      <main className='mx-auto max-w-7xl text-center'>
            ...
            <p className='font-bold text-[16px] p-4'>Are you looking for a convenient and effective way to Learn Quran Online? Pak Quran Academy is here to provide you with an exceptional online Quran learning
